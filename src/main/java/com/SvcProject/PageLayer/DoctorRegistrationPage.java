...
public class DoctorRegistrationPage extends TestBase {
	...
	private WebElement doctormodule_link;
	
	@FindBy(xpath="//span[text()='Doctor Registration']")
	private WebElement doctorregistration_link;
	...
	{
		doctormodule_link.click();
		doctorregistration_link.click();
	}
