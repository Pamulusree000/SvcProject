...
import com.SvcProject.TestBase.TestBase;
	...
	public class WebDriverUtils extends TestBase{
		...
		public void flashElement(WebElement element) throws Exception {
		...
		public void selectElementFromList(WebElement listEle, WebElement txtEle, String str) throws Exception {
		...
		public boolean isClickable(WebElement element) throws Exception {
		...
		public void sendData(WebElement element, String text) throws Exception {
		...
		public void clearTextWithBackSapce(WebElement element) throws Exception {
		...
		public String getElementAttributeValue(By locator, String attribute) throws Exception {
		...
		public String getElementAttributeValue(WebElement element, String attribute) throws Exception {
		...
		public String getElementCssValue(WebElement element, String cssProperty) throws Exception {
		...
		public void unCheck(WebElement element) throws Exception {
		...
		public Boolean submit(WebElement element, String info) throws Exception {
		...
		public boolean isDropdownOptionExists(WebElement element, String optionToVerify) throws Exception {
		...
		public void doSelectDropDownValue(By locator, String value) throws Exception {
		...
		public void selectOptionList(WebElement element, String optionToSelect) throws Exception {
		...
		public boolean selectOption(List<WebElement> element, String option) throws Exception {
		...
		public void selectOption(WebElement element, String optionToSelect) throws Exception {
		...
		public void rightClick(By locator, String info) throws Exception {
		...
		public void selectItemRightClick(By elementLocator, By itemLocator) throws Exception {
		...
		public void selectSubMenu(String htmltag, String parentMenu, String childMenu) throws Exception {
		...
		public WebElement retryingElement(By locator, int timeOut) throws Exception {
		...
		public WebElement retryingElement(By locator, int timeOut, int intervalTime) throws Exception {
