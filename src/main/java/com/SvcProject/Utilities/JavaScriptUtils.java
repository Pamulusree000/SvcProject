...
public class JavaScriptUtils {
	...
	public void flash(WebElement element) throws Exception {
	...
	public String getInnerText(WebElement ele) {
		...
		return jse.executeScript("return arguments[0].innerText;", ele).toString();
	}
	...
	public String getValue(WebElement ele) {
		JavascriptExecutor jse = (JavascriptExecutor)driver;
		Object value = jse.executeScript("return arguments[0].value;", ele);
